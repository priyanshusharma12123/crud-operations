...
<html lang="en">
  ...
  <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
    ...
    <title>Crud Operations - Elite Softwares, Pune</title>
    <meta charset="utf-8">
  ...
  <body>
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
			    		<div class="col-md-5 pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">Narhe, Pune</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon bg-secondary mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
						    <span class="text">swami@elitesoftwares.co.in</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon bg-tertiary mr-2 d-flex justify-content-center align-items-center"><span class="icon-phone2"></span></div>
						    <span class="text">9096622683</span>
					    </div>
				    </div>
			    </div>
		    </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco_navbar ftco-navbar-light" id="ftco-navbar">
	    <div class="container d-flex align-items-center">
			...
			<img src="images/logo.jpg" style="height:100px;width:50%;"/> D. Y. Patil - COE </a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	...
	        	<li class="nav-item"><a href="pricing.html" class="nav-link">Gallery</a></li>
	        	
	          <li class="nav-item"><a href="contact.php" class="nav-link"><button type="button" class="btn btn-info">Contact</button></a></li>
			  
			  <li class="nav-item">
			  <a href="#" class="nav-link">
			  <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">Enquiry
			  </button>
			  </a>
			  </li>
    ...
    <section class="ftco-services ftco-no-pb">
          ...
          <div class="col-md-3 d-flex services align-self-stretch pb-4 px-4 ftco-animate bg-primary">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3" data-aos="zoom-in-up">
                <h3 class="heading">Certified Teachers</h3>
                <p>Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-6 d-flex services align-self-stretch pb-4 px-4 ftco-animate bg-tertiary" >
            <div class="media block-6 d-block text-center">
              <div class="icon d-flex justify-content-center align-items-center" style="margin-left:49%">
   <img src="images/logo.jpg" style="height:50px;" />
              </div>
              <div class="media-body p-2 mt-3" data-aos="flip-left">
               <center> <h1>
				&nbsp;&nbsp;&nbsp;ZEAL Education Society, Pune
				</h1>
				<img src="images/logo.jpg" style="height:200px;width:44%;"/>
          ...
          <div class="col-md-3 d-flex services align-self-stretch pb-4 px-4 ftco-animate bg-fifth" style="background-color:green;">
            <div class="media block-6 d-block text-center">
              <div class="icon d-flex justify-content-center align-items-center">
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
	...
	<?php
		if(isset($_POST['submit']))
		{
			...
			if($res)
			{
				echo "<script>alert('Enquiry Successfully Submitted');window.location='index.php';</script>";
			}					
		}
		?>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog" style="background: #eaeaeabf;">

    <!-- Modal content-->
    <div class="modal-content" style="background: #eaeaeabf;">
      ...
      <div class="modal-body">
        <form action="index.php" method="post">
            <div class="form-left-to-mids" style="margin-bottom:20px;">
               <input type="text" name="name" placeholder="Full Name" required="" style="font-size: 14px;
               padding: .5em 1em;margin: 0px 0px 25px;width: 100%;background: #f5f3f3bf;border-bottom: #00a1ff 2px solid;">
            </div>
						
            <div class="form-left-to-mids"style="margin-bottom:20px;">
                <input type="text" name="phone" placeholder="Mobile Number" maxlength="10" minlength="10" onkeypress="return isNumber(event)" required="" style="font-size: 14px;
                padding: .5em 1em;margin: 0px 0px 25px;width: 100%; background: #f5f3f3bf;border-bottom: #00a1ff 2px solid;">
            </div>
            <div class="form-left-to-mids" style="margin-bottom:20px;">
                <input type="email" name="email" placeholder="Email" style="font-size: 14px;
                padding: .5em 1em;margin: 0px 0px 25px;width: 100%;background: #f5f3f3bf;border-bottom: #00a1ff 2px solid;">
            </div>
            <div class="form-left-to-mids" style="margin-bottom:20px;">
                <input type="text" name="address" placeholder="Address" style="font-size: 14px;
                padding: .5em 1em;margin: 0px 0px 25px;width: 100%;background: #f5f3f3bf;border-bottom: #00a1ff 2px solid;">
            </div>
...
s1.async=true;
s1.src='https://embed.tawk.to/5d99c496db28311764d78317/default';
s1.charset='UTF-8';
